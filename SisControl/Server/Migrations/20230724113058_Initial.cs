    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Este Aqui", "29.200-001", "Guarapari", "Apto 001", "111.111.111-11", new DateTime(2023, 7, 24, 8, 30, 58, 156, DateTimeKind.Local).AddTicks(2320), new DateTime(2023, 7, 24, 8, 30, 58, 156, DateTimeKind.Local).AddTicks(2304), new DateTime(1972, 12, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "testeum@teste.com", "Rua da minha casa, 001", "(27) 99999-1234", "Primeira Pessoa Cadastrada", "ES" },
                    { 2, "Este Aqui", "29.200-002", "Guarapari", "Apto 002", "222.222.222-22", new DateTime(2023, 7, 24, 8, 30, 58, 156, DateTimeKind.Local).AddTicks(2449), new DateTime(2023, 7, 24, 8, 30, 58, 156, DateTimeKind.Local).AddTicks(2448), new DateTime(1974, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "testedois@teste.com", "Rua da minha casa, 002", "(27) 99999-2345", "Segunda Pessoa Cadastrada", "ES" },
                    { 3, "Este Aqui", "29.200-003", "Guarapari", "Apto 003", "333.333.333-33", new DateTime(2023, 7, 24, 8, 30, 58, 156, DateTimeKind.Local).AddTicks(2469), new DateTime(2023, 7, 24, 8, 30, 58, 156, DateTimeKind.Local).AddTicks(2468), new DateTime(1997, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "testetres@teste.com", "Rua da minha casa, 003", "(27) 99999-3456", "Terceira Pessoa Cadastrada", "ES" }
                });
